...
class Boat(Transport):
    def start_engine(self):
        print('Катер заработал')

    def stop_engine(self):
        print('Двигатель катера перестал работать')

    def move(self):
        print('Скорость катера набирается')
...
class Car(Transport):
    def start_engine(self):
        print('Двигатель машины заработал')

    def stop_engine(self):
        print('Машина стоит с заглушенным двигателем')

    def move(self):
        print('Скорость машины набирается')
...
class Electroscooter(Transport):
    def start_engine(self):
        print('Электроскутер заработал')

    def stop_engine(self):
        print('Электроскутер перестал работать')

    def move(self):
        print('Едет по навигатору')
